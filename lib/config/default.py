...
_C.DATASET.LABELROOT = 'data/bdd100k/det_annotations'      # the path of det_annotations folder
_C.DATASET.MASKROOT = 'data/bdd100k/da_seg_annotations'                # the path of da_seg_annotations folder
_C.DATASET.LANEROOT = 'data/bdd100k/ll_seg_annotations'               # the path of ll_seg_annotations folder
